...
public class AdminSettingsPlugin extends SettingsPanelPlugin {
    ...
    public String getPluginPointName() {
        return String.join(" ", Constants.POINT_NAME, Constants.SETTINGS_TAB_NAME);
    }

    @Override
    public void start() {
        ObjectXMLSerializer.getInstance().allowTypes(List.of("com.dedalus.adminplugin.shared.model.CustomMapping"),
                null, null);
